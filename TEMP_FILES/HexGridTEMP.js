...
var topic = ["apple,a,aand,ape,argue,always","bear,b","cat,c","dog,a","ear,c","frog,a","grape,w","hello,a","idiot,a","jacob,a","khan,a","lemon,a",
			 "monopoly,m,m","new,n,n","orange,o,o","pear,p,p","queue,q,q","rare,r,r","straight,s,s","turn,t,t","under,u,u","vehicle,v,v","wheel,a",
			 "xyz,a","yellow,a","zebra,a","abert,a","acar,a","adog,a","aear,a","afrog,a","agrape,a","ahouse,a","aindie,a","ajacob,a","akerry,a",
			 "alemon,a,a","aman,a,a,a","annoodle,a,a,a,a,a,a","aorange,a,a,a"];
var topicId=["apple","bear","cat","dog","eagle","frog","grape","hi"];
///////////////////////////////////////////////////////////////////////////
...
svg.append("g")
 ...
 d3.layout.cloud().size([100, 100])
     .words([
        "migrant and me ","asian","identity","cultural","state","conflict","country","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious","ethnic","religious"].map(function(d) {
       // return {text: d, size: 1 + Math.random() * 50};
	   return {text: d, size: 2};
      }))
      .padding(7)
      .rotate(0)
      .font("Helvetica")
...
.on("mouseover", mover)
 ...
 function wordle{
 d3.layout.cloud().size([100, 100])
      .words(topicId.map(function(d) {
       // return {text: d, size: 1 + Math.random() * 50};
	   return {text: d, size: 4};
      }))
      .padding(2)
      .rotate(0)
      .font("Helvetica")
